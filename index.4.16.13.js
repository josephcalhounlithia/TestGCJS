...
//             <div class="compare--img-box gc-clear">${drawCarHeader(compareData)}</div>
...
//         </div>
//         <div class="greenscore--car-label gc-clear">${drawCarGreenScore(compareData)}</div>
...
//         ${createCompareItem('Time to charge 240v', drawCarChargeTime240, compareData)}
...
//         ${createCompareItem('Incentives available', drawIncentives, compareData)}
//         ${createCompareItem('Federal tax credits', drawFederalTax, compareData)}
//         ${createCompareItem('Energy cost per mile', drawCarEnergyCostMile, compareData)}
//         ${createCompareItem('Monthly fuel cost*', drawCarEnergyCost, compareData)}
//         ${createCompareItem('Total monthly cost*', drawTotalMonthlyCost, compareData)}
//         ${createCompareItem('Cost per mile of range*', drawCostRangeMile, compareData)}
//         ${createCompareItem('kWh per Mile', drawMilesKwh, compareData)}
...
//             <div class="affordscore--label gc-clear">${drawCarAffordabilityScore(compareData)}</div>
...
//             ${createCompareItem('Annual CO2 emissions', drawCarCo2, compareData)}
//             ${createCompareItem('EPA smog rating', drawEpaSmogRating, compareData)}
//             <div class="compare--item-header">
...
//         <div class="compare--item-description gc-clear">${comparison(data)}</div>
//     </div>
// </div>`;
// }
...
//                     <div class="details-category-value">${e.performanceScore} out of 5</div>
//                 </div>
//             </div>
...
//                     <div class="details-category-value">${e.affordabilityScore} out of 5</div>
//                 </div>
//             </div>
...
//                     <div class="details-category-value">${e.environmentScore} out of 5</div>
//                 </div>
//             </div>
//         </div>
...
//         </div>
//         <div onclick="openFavCarDetails(${e.id})" class="gc-fav-inner-content"><img src="${
//     e.image
...
//                     <div fs-cmssort-field="price">${formatter.format(e.estPrice)}</div>
//                 </div>
//             </div>
//         </div>
//     </div>
...
//     type = type == 'green' ? 'car-details-driveway-button' : 'gc-fav-driveway-btn';
//     if (e.preOrderUrl != '') {
//       url = e.preOrderUrl;
//       label = 'Pre-order';
//     } else {
...
//     `Comparing ${compareData.length} ${compareData.length === 1 ? 'Vehicle' : 'Vehicles'}`
//   );
// }
/* -----------------------*/
/* -----SWITCHES----*/
...
function openCarDetails(e) {
  ...
  $('[gc-element-variable="contact_us_button"]').on('click', function(){
    $('[gc-element-variable="contact_us_form"]').show();
  });
...
//   if (!flag) {
//     id == null ? (compareData = []) : compareData.push(constructDataObj(id, lineItem));
//   }
